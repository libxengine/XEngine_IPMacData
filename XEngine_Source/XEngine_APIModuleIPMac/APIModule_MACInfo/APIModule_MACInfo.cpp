...
bool CAPIModule_MACInfo::APIModule_MACInfo_Init(LPCXSTR lpszDBFile)
{
	...
	if ((XENGIEN_COMMUNICATION_PACKET_PROTOCOL_HEADER != st_ProtocolHdr.wHeader) || (XENGIEN_COMMUNICATION_PACKET_PROTOCOL_TAIL != st_ProtocolHdr.wTail) || (ENUM_XENGINE_COMMUNICATION_PROTOCOL_TYPE_IPMAC != st_ProtocolHdr.unOperatorType) || (XENGINE_COMMUNICATION_PROTOCOL_OPERATOR_CODE_MAC != st_ProtocolHdr.unOperatorCode))
	{
		IPMac_IsErrorOccur = true;
